...
async def bb_jwt_crack(
    ...
    common_secrets = [
        ...
        # Top 100 JWT 薄弱密钥
        "jwt_secret", "jwt-secret", "jwtsecret", "jwt_token", "jwt-token",
        "jwttoken", "jwt_key", "jwt-key", "jwtkey",
        "mysecret", "my-secret", "my_secret", "mysecretkey",
        "myprivatekey", "my-private-key", "my_private_key",
        "app_secret", "appsecret", "app-secret",
        "api_key", "apikey", "api-secret", "api_secret",
        "auth_secret", "authsecret", "auth-key", "auth_key",
        "session_secret", "sessionsecret", "session-key",
        ...
        "passwd", "p@ssword", "P@ssw0rd", "p@ss",
        "admin123", "admin123456", "root123",
        "qwerty123", "qwe123", "asdfgh",
        "1qaz2wsx", "zaq1xsw2", "1q2w3e4r",
        "letmein", "welcome", "welcome123", "hello123",
        "master", "masterkey", "master_key",
        "login", "login123", "auth123",
        "system", "system123", "manager",
        "server", "server123", "localhost",
        "dev", "dev123", "development", "debug",
        "stage", "staging", "prod", "production",
        "test123", "testing", "demo", "demo123",
        "guest", "guest123", "user123",
        "superadmin", "superuser", "administrator",
        "company", "company123", "corp", "corp123",
        "internal", "internal123", "prod123",
        "s3cret", "supersecret", "verysecret",
        "topsecret", "top-secret", "ultrasecret",
        "changethis", "changeme123", "mustchange",
        "temp", "temp123", "temporary",
        "newsecret", "new_secret", "new-key",
        "backup", "backup123", "bak",
    ]
